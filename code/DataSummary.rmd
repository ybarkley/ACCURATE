...
#All Acoustics Only vs Sighted - NO CODA
```{r}
...
#plotting only whales less than 6 km away
dataCloseWhales <- dataCodaNone %>% filter(dist < 4, rating >1) %>%
  select(ID, survey, acid, sid, UTC, lat, lon, nclk, minutes, grpsize, click_code, array, year, label, dist)
